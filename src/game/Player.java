...
public class Player {
    ...
    private String nom;
    private int positionVictoire; //Sert pour les parties d'aprÃ¨s
    private int positionInitiale; //Sert pour faire le sens du jeu = Valeur qui ne bouge pas Ã  chaque nouvelle partie
